...
class CustomSlider extends HTMLElement {
    ...
    async initialize() {
        ...
        this.#log('Swiper available, creating instance on cached element', { version: Swiper.version || 'unknown', slideCount: this.#renderedElement.querySelectorAll('.swiper-slide').length });
