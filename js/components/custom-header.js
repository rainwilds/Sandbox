            ...
            async render(isFallback = false) {
                ...
                if (!isFallback) {
                    ...
                    if (attrs.imgBackgroundLightSrc || attrs.imgBackgroundDarkSrc) {
                        const resolutions = ['768', '1024', '1366', '1920', '2560', '3840'];
                        const lightBase = attrs.imgBackgroundLightSrc.replace(/\.jpg$/, '');
                        const darkBase = attrs.imgBackgroundDarkSrc.replace(/\.jpg$/, '');
                        pictureHTML = `
                            <picture class="animate animate-fade-in">
                                ${attrs.imgBackgroundLightSrc ? resolutions.map(res => `
                                    <source media="(prefers-color-scheme: light)" type="image/jxl" srcset="/Sandbox/img/responsive/tourism-photography-light-4-${res}.jxl ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                    <source media="(prefers-color-scheme: light)" type="image/avif" srcset="/Sandbox/img/responsive/tourism-photography-light-4-${res}.avif ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                    <source media="(prefers-color-scheme: light)" type="image/webp" srcset="/Sandbox/img/responsive/tourism-photography-light-4-${res}.webp ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                    <source media="(prefers-color-scheme: light)" type="image/jpeg" srcset="/Sandbox/img/responsive/tourism-photography-light-4-${res}.jpeg ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                `).join('') : ''}
                                ${attrs.imgBackgroundDarkSrc ? resolutions.map(res => `
                                    <source media="(prefers-color-scheme: dark)" type="image/jxl" srcset="/Sandbox/img/responsive/tourism-photography-dark-6-${res}.jxl ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                    <source media="(prefers-color-scheme: dark)" type="image/avif" srcset="/Sandbox/img/responsive/tourism-photography-dark-6-${res}.avif ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                    <source media="(prefers-color-scheme: dark)" type="image/webp" srcset="/Sandbox/img/responsive/tourism-photography-dark-6-${res}.webp ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                    <source media="(prefers-color-scheme: dark)" type="image/jpeg" srcset="/Sandbox/img/responsive/tourism-photography-dark-6-${res}.jpeg ${res}w" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 100vw, (max-width: 1366px) 100vw, (max-width: 1920px) 100vw, (max-width: 2560px) 100vw, 3840px" data-alt="${attrs.imgBackgroundAlt}">
                                `).join('') : ''}
