...
function manageHead(attributes = {}, businessInfo = {}) {
  console.log('manageHead called with attributes:', attributes); // Debug attributes
  try {
    ...
    heroImages.forEach(image => {
      try {
        ...
        console.error(`Error preloading hero image ${image.href}:`, error);
      }
    });
    ...
    fonts.forEach(font => {
      try {
        ...
        console.error(`Error preloading font ${font.href}:`, error);
      }
    });
    ...
    fontAwesomeStyles.forEach(href => {
      try {
        ...
        console.error(`Error preloading Font Awesome style ${href}:`, error);
      }
    });
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  console.log('Merged attributes:', attributes); // Debug attributes
  ...
  try {
    ...
    console.error('Error calling manageHead:', error);
  }
});