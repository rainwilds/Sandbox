...
function manageHead(attributes = {}, businessInfo = {}) {
  ...
  try {
    ...
    try {
      ...
      console.error('Error preloading Font Awesome styles:', error);
    }
    ...
    try {
      ...
      console.error('Error adding Permissions-Policy meta:', error);
    }
    ...
    try {
      ...
      try {
        ...
        console.error('Error adding OG meta tags:', error);
      }
      ...
      try {
        ...
        console.error('Error adding Twitter meta tags:', error);
      }
      ...
      try {
        ...
        console.error('Error adding JSON-LD schema:', error);
      }
      ...
      try {
        ...
        console.error('Error loading Font Awesome stylesheets:', error);
      }
      ...
      try {
        ...
        if (!document.querySelector(`link[rel="stylesheet"][href="${mainStylesheet}"]`)) {
          ...
          head.appendChild(link);
          console.log('Added main stylesheet');
        }
      } catch (error) {
        console.error('Error adding main stylesheet:', error);
      }
      ...
      try {
        ...
        console.error('Error initializing Snipcart:', error);
      }
      ...
      console.error('Error in manageHead:', error);
    }
  }
  ...
  try {
    ...
    dataHeads.forEach(dataHead => {
      try {
        ...
        console.error('Error parsing data-bh-head attributes:', error);
      }
    });
    ...
    dataHeads.forEach(dataHead => {
      try {
        ...
        console.error('Error removing data-bh-head:', error);
      }
    });
