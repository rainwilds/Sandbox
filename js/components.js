class Img extends HTMLElement {
  ...
  connectedCallback() {
    ...
    // Construct primary image path with -3840 in img/primary/ using absolute URL
    const primaryImagePath = `https://rainwilds.github.io/Sandbox/img/primary/${baseFilename}-3840.jpg`;
    ...
    img.src = primaryImagePath; // Use absolute URL for the primary image
    img.alt = alt;
    img.loading = 'lazy';
    if (aspectRatio) {
